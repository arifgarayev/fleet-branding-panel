...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        # returns user's model object with that username
            ...
            # fixme
            return render_template('./auth/login_view.html', title=title, is_error=True,
                                   error_msg="Bir xəta baş verdi!"
                                             " Zəhmət olmasa yenidən cəhd edin.", form=login_form)
        ...
        if user_controller.validate_username_and_password(request.form['password'], request.form['username'].lower()):
            ...
            if (keywords_model := keyword_repo.get_current_keyword()):
                ...
                print('I AM INSIDE (keywords_model := keyword_repo.get_current_keyword())')
        ...
        return render_template('./auth/login_view.html', title=title,
                               is_error=True,
