...
class CompanyRepository:
    ...
    def find_by_internal_company_name(self, company_name):
        return (
            ...
            .filter_by(internal_company_name=company_name)
            .first()
        )
    ...
    def get_by_internal_company_id(self, internal_company_id):
        ...
        return (
            self._session.query(Company)
            .filter_by(internal_company_id=internal_company_id)
            .first()
        )
    ...
    def get_internal_company_by_name(self, internal_company_name):
        return (
            self._session.query(Company)
            .filter_by(internal_company_name=internal_company_name)
            .first()
        )
    ...
    def create_new_company(
        ...
        self._session.add(
            Company(
                internal_company_name=internal_company_name,
