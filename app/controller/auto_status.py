...
class AutoStatusController:
    ...
    async def add_new_record_for_application(self, car_id, is_requested_to_delete, type_of_application=3):
        # known values: car_id, user_id, quote,
        # create an event loop
        await self.applications_repo.add_new_application(car_id=car_id,
                                                    user_id=current_user.id,
                                                         folder_uuid=None, filename=None,
