...
from dependencies import db, bcrypt, csrf, \
    executor, async_session

from app.sessionInterface.custom_session import \
...
from app.view.error_handler import app as error_handler_bp, \
    page_not_found, not_a_weekday
...
list_of_repos = [user_repository, car_repository, applications_repository, company_repository, keyword_repo]
